...
public:
    ...
    DoubleBox(const
              T1 value1, const T2 value2):ch1(value1), ch2(value2) {};
    T1 get1() const;
    T2 get2() const;
    void get() const;
...
template
<typename T1, typename T2> void DoubleBox<T1, T2>::set(const T1 value1, const T2 value2)
{
    ch1 = value1;
    ch2 = value2;
}
...
{
    DoubleBox<int, double> doubleM(12,12.5546);
    cout << doubleM.get1() << endl;
    cout << doubleM.get2() << endl;
    doubleM.set(6, 6.45786);
    cout << doubleM.get1() << endl;
    cout << doubleM.get2() << endl;
    doubleM.get();
    return 0;
